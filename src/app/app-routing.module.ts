...
import { RegisterPlayersComponent } from './views/pages/register-players/register-players.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path:'registerTeams',
        component: RegisterTeamsComponent,
        pathMatch: 'full'
      },
      {
        path:'viewAllPlayers',
      ...
      // {
      //   path: 'fooseball-team',
      //  component: FooseballTeamComponent,
      //  pathMatch: 'full'
